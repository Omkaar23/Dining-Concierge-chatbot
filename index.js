...
var baseUrl = 'https://pe1mvgjfag.execute-api.us-east-1.amazonaws.com/dev';
...
// apigClient.chatbotOptions(params, body, additionalParams)
//     .then(function(result){
//       // Add success callback code here.
//     }).catch( function(result){
//       // Add error callback code here.
...
function createNewMessage(message) {
	...
	$chatlogs.append(
		$('<div/>', {'class': 'chat friend'}).append(
			$('<div/>', {'class': 'user-photo'}).append($('<img src="Images/anna.png" />')), 
